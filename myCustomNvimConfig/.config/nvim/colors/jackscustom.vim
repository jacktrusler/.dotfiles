...
let s:orange      = { "gui": "#e0911f", "cterm": "200" }
let s:yellow      = { "gui": "#e5c07b", "cterm": "180" }
let s:brightYel   = { "gui": "#ffe078", "cterm": "180" }
let s:blue        = { "gui": "#61afef", "cterm": "75"  }
let s:brightBlue  = { "gui": "#89c4f4", "cterm": "75"  }
let s:purple      = { "gui": "#c678dd", "cterm": "176" }
let s:cyan        = { "gui": "#56b6c2", "cterm": "73"  }
let s:white       = { "gui": "#dcdfe4", "cterm": "188" }
let s:menu        = { "gui": "#323742", "cterm": "242" }

let s:fg          = s:white
let s:bg          = s:black

" Autocomplete Highlighting
highlight! CmpItemAbbr                guibg=NONE guifg=#dcdfe4
highlight! CmpItemAbbrMatch           guibg=NONE guifg=#569CD6
highlight! CmpItemAbbrMatchFuzzy      guibg=NONE guifg=#569CD6
highlight! CmpItemKindFunction        guibg=NONE guifg=#C586C0
highlight! CmpItemKindMethod          guibg=NONE guifg=#C586C0
highlight! CmpItemKindVariable        guibg=NONE guifg=#9CDCFE
highlight! CmpItemKindKeyword         guibg=NONE guifg=#E06C75
...
call s:h("SpellLocal", s:green, "", "")
call s:h("SpellRare", s:cyan, "", "")
...
call s:h("Number", s:brightBlue, "", "")
call s:h("Boolean", s:brightBlue, "", "")
call s:h("Float", s:brightBlue, "", "")

call s:h("Identifier", s:blue, "", "")
call s:h("Function", s:brightYel, "", "")
...
" Special is what controls JSX components highlighting!!
...
call s:h("Ignore", s:red, "", "")
call s:h("Error", s:red, s:gutter_bg, "")
call s:h("Todo", s:purple, "", "")
" JSX specific highlighting
call s:h("jsxComponentName", s:red, "", "")
call s:h("tsxTagName", s:green, "", "")
" }
